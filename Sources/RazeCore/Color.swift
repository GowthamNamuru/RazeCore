...
extension RazeCore {
    public class Color {
        ...
        /// - Parameters:
        ///   - hexString: A 6-digit hexadecimal string. Use 6 digits rather than 8, and add the accompanying alpha valu in the second parameter.
        ...
        internal class func fromHexString(_ hexString: String,_ alpha: CGFloat = 1.0) -> UIColor {
            let r, g, b: CGFloat
        ...
        /// Return an object of **UIColor** with the second most eye-pleasing color known to all humanity.
